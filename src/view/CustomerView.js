...
export class CustomerView extends View {
  ...
  async init() {
    this.#orderTemplate = await this.loadTemplate(
      './src/view/templates/past-order.html'
    );
  ...
  renderCustomerDetails(customer) {
    ...
    this.#userTicket.value = customer.avg_ticket.toLocaleString('pt-BR', {
