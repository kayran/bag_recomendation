export class CustomerService {
  ...
  async getDefaultCustomers() {
    const [customersResponse, ordersResponse, availabilityResponse] =
      await Promise.all([
      ...
      return {
        ...
        purchases: orders
          ...
          .map((order) => ({
            ...
            type: order.type,
            score: order.score,
            score_variety: order.score_variety,
            score_quantity: order.score_quantity,
            score_quality: order.score_quality,
          })),
      };
    });
